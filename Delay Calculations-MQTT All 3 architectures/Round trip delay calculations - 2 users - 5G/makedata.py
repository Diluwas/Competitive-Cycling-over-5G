...
file1 = open("G:\FYP\Delay Calculations\Round trip delay calculations - 2 users - 5G\mydataserial.txt", "r")
...
with open("G:\FYP\Delay Calculations\Round trip delay calculations - 2 users - 5G\publishtimes.txt", "w") as file2:
    for i in mypubtimes:
        file2.write(str(i)+"\n")
with open("G:\FYP\Delay Calculations\Round trip delay calculations - 2 users - 5G\subscribetimes.txt", "w") as file3:
    for i in mysubtimes:
        file3.write(str(i)+"\n")
with open("G:\FYP\Delay Calculations\Round trip delay calculations - 2 users - 5G\myspeeds.txt", "w") as file4:
    for i in speeds:
        file4.write(str(i)+"\n")
